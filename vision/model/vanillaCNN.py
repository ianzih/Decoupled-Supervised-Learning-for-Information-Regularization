...
class CNN(nn.Module):
    def __init__(self, args):
        ...
        self.fc = nn.Sequential(Flatten(), nn.Linear(4096, 5*num_neurons), nn.Sigmoid(), nn.Linear(5*num_neurons, args.n_classes))
...
class CNN_AL(nn.Module):
    def __init__(self, args):
        ...
        self.layer1 = CNN_AL_Component(block_1, 32*32*32, neurons, self.num_classes)
